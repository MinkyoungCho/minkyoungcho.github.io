...
\fancyfoot[R]{\footnotesize{{Last updated: Feb 10, 2026}}}
...
\parbox{\textwidth}{Multi-Modal, Efficient AI, Robust AI, Autonomous Driving, PEFT, Post-Training}
...
\begin{enumerate}[leftmargin=*, itemsep=0em]
  \item \small \textbf{MARS: Harmonizing Multimodal Convergence via Adaptive Rank Search} \\
  \textbf{Minkyoung Cho}, Insu Jang, Shuowei Jin, Zesen Zhao, Adityan Jothi, Ethem F. Can, Min-Hung Chen$^\ast$, and Z. Morley Mao$^\ast$ \\
  Under Submission ($^\ast$\textbf{Equal Advising})
  \item \small \textbf{GraphMap: Scalable Crowd-Sourced Global Vectorized HD Map Construction via Sparse Visual Graph Fusion} \\
  Ruiyang Zhu, \textbf{Minkyoung Cho}, Shuqing Zeng, Fan Bai, and Z. Morley Mao \\
  Under Submission
  \item \small \textbf{Dynamic Linear Attention} \\
  Xin Wang, Hui Shen, Boyuan Zheng, Xueshen Liu, \textbf{Minkyoung Cho}, Zhongwei Wan, Zesen Zhao, Z. Morley Mao, Mi Zhang, and Shen Yan \\
  Under Submission
  \item \small \textbf{TC-LoRA: Temporally Modulated Conditional LoRA for Adaptive Diffusion Control} \\
  \textbf{Minkyoung Cho}, Ruben Ohana, Christian Jacobsen, Adityan Jothi, Zhuoqing Mao, Min-Hung Chen, and Ethem F. Can \\
  ...
  ICLR 2025 
  \item \small \textbf{SCORPION: Robust Spatial-Temporal Collaborative Perception Model
  on Lossy Wireless Network} \\
  Ruiyang Zhu, \textbf{Minkyoung Cho}, Shuqing Zeng, Fan Bai, and Z. Morley Mao \\
  IROS 2025 (Oral)
  \item \small \textbf{\href{https://ry4nzhu.github.io/publication/scalable_crowded_hd_map_construction/scalable_crowded_HD_map_construction.pdf}{CrowdMap: Scalable Crowd-sourced Global HD Map Construction via Collaborative Map Perception and Sparse Graph Fusion}} \\
  Ruiyang Zhu$^\ast$, \textbf{Minkyoung Cho$^\ast$}, Shuqing Zeng, Fan Bai, Xiang Gao, and Z. Morley Mao \\
  CVPR Workshop 2025  ($^\ast$\textbf{Equal Contribution})
...
\section{Academic Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
    \resumeItem{[Vision+Language] MLLM Fine-Tuning}{Identified an imbalanced training dynamics problem and developed an MLLM fine-tuning algorithm to mitigate it. Paper (MARS) under submission.}
    \resumeItem{[2D Vision+3D Vision] Multimodal Perception}{Designed a robust multimodal perception framework and proposed an uncertainty quantification and comparison algorithm across heterogeneous modalities. Cocoon accepted to ICLR 2025.}
    \resumeItem{[Multi-Agent Visual Feature Fusion] Collaborative Perception}{Built a robust collaborative perception and HD map construction system for connected and automated vehicles. SCORPION (IROS 2025 Oral), CrowdMap (CVPRW 2025), GraphMap (under submission).}
    \resumeItem{[3D Vision+Time] Anomaly Detection}{Developed a method for detecting anomalies by checking temporal consistency in 3D point clouds. ADoPT accepted to BMVC 2023.}
    \resumeItemListEnd
    \resumeSubheading
...
\resumeSubHeadingListStart
  ...
  {NVIDIA}{May 2025 -- Aug 2025}
    \resumeItemListStart
    \resumeItem{[Vision+Language+Time] Controllable Diffusion Models}{Researched optimal conditioning algorithms for generative AI models (e.g., NVIDIA Cosmos), aiming for improved conditional guidance over standard methods (e.g., ControlNet). Paper (TC-LoRA) accepted to NeurIPSW 2025.} 
    \resumeItemListEnd
   \resumeSubheading
    {Deep Learning Software Intern}{Santa Clara, CA, USA}
    {NVIDIA}{Jun 2024 -- Aug 2024}
    \resumeItemListStart
    \resumeItem{[Vision+Language] Efficient Fine-Tuning for Multimodal Models}{Developed parameter-efficient fine-tuning methods (e.g., LoRA) for multimodal models. Paper (MARS) under submission.}
    \resumeItemListEnd
    \resumeSubheading
...
\resumeSubHeadingListStart
  ...
  \resumeItem{Conference Reviewer}{ICLR, IROS, ICML, BMVC, CPAL, NeurIPSW, ICLRW, CVPRW}
\resumeSubHeadingListEnd
