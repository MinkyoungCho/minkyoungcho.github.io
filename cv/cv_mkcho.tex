...
\parbox{\textwidth}{Robust AI, Efficient AI, DNN Optimization, 3D Perception, Autonomous Driving, Anomaly Detection}
...
\begin{enumerate}[leftmargin=*, itemsep=0em]
  ...
  Uncertainty-Aware Sensor Fusion.''}} \textit{In Submission }, May 2024.
