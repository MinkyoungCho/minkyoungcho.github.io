...
\fancyfoot[R]{\footnotesize{{Last updated: October 2, 2021}}}
...
Autonomous Driving, Collaborative Perception, 3D Object Detection, 3D Scene Understanding, Anomaly Detection, Machine Learning, Neural Network Optimization
...
\section{Academic Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Anomaly Detection on Autonomous Driving}{Designed anomaly detection algorithm by checking temporal consistency of 3D point clouds.}
    \resumeItemListEnd
    \resumeSubheading
