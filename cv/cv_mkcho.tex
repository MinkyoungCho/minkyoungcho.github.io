...
\fancyfoot[R]{\footnotesize{{Last updated: Oct 3, 2023}}}
...
\section{Education}
  ...
  \vspace{-1pt}\item
    \begin{tabularx}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
      ...
      \textit{\small Ph.D. Student in Computer Science and Engineering (GPA: 4.0 / 4.0)} & \small Aug 2022 -- Present \\
  ...
  \vspace{-1pt}\item
      \begin{tabularx}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
        ...
        \textit{\small Master of Science in Computer Science (GPA: 3.66 / 4.3)} & \small Mar 2015 -- Feb 2017 \\
        \small Advisor: Prof. Younghee Lee  \\
    \end{tabularx}\vspace{-5pt}
    \vspace{-1pt}\item
      \begin{tabularx}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
        \textbf{Ewha Womans University} & Seoul, Republic of Korea \\
        \textit{\small Bachelor of Science in Computer Science and Engineering (GPA: 4.03 / 4.3)} & \small Mar 2011 -- Feb 2015 \\
...
\section{Academic Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Activity Segmentation}{Found a research topic in IoT environment, designed and implemented an automated activity segmentation system, and led to paper submission.}
