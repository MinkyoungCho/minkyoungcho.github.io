...
\fancyfoot[R]{\footnotesize{{Last updated: June 3, 2024}}}
...
\parbox{\textwidth}{Robust AI, Efficient AI, 3D Perception, Autonomous Driving, Anomaly Detection, DNN Optimization}
...
\begin{enumerate}[leftmargin=*, itemsep=0em]
  \item \small \textbf{Minkyoung Cho}, Yulong Cao, Jiachen Sun, Qingzhao Zhang, Marco Pavone, Jeong Joon Park, Heng Yang, Z. Morley Mao. \textbf{\href{https://minkyoungcho.github.io/research/}{``AdaFuse: Rethinking Multi-Modal Perception with Uncertainty-Aware Sensor Fusion (\textbf{Temporary title}).'}} \textit{In Submission }, May 2024.
...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Large DNN Optimization}{Working on finetuning and inference optimization techniques.}
    \resumeItemListEnd
    \resumeSubheading
